...
async def runways(airport: str):
    ...
    favored = FavoredRunway(reason="No runway data")
    
    if not runways_raw:
        favored.reason = "No runway data available."
    elif not metar:
        favored.reason = "No field wind available."
    elif wind_spd == 0:
        favored.reason = "Calm. Any runway may be used."
    elif variable_wind:
