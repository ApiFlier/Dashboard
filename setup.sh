...
echo "Access Ops Mode at:     http://localhost:$PORT/#/ops"
echo ""
echo "Runtime data is stored in Docker volume 'airfieldops_state'."
echo "Container restart policy is 'unless-stopped', so the app will"
echo "start again after a host reboot unless you explicitly stop it."
...
echo "  This does not delete runtime data, but it removes local scripts."
echo ""
